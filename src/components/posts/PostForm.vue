...
<template>
  <form @submit.prevent="handleSubmit" class="space-y-4">
    <div>
      <label for="post-title" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Título</label>
      <input 
        id="post-title" 
        v-model="title" 
        type="text" 
    ...
    <div>
      <label for="post-content" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Conteúdo</label>
      <textarea 
        id="post-content" 
        v-model="content" 
        rows="4" 
