...
function canDeleteComment(comment: Comment) {
  ...
  return (
    comment.authorId === currentUser.value.uid ||
    props.postAuthorId === currentUser.value.uid
  );
}
</script>
    ...
    >
      ...
      >
        <div class="flex items-center">
          ...
          >
            <div
              class="h-8 w-8 rounded-full mr-2 bg-primary-500 text-white flex items-center justify-center text-sm"
            >
